...
Original file is located at
    https://colab.research.google.com/drive/1mSezQoJUhskhfdah80hRKdJYHkptl1Qa
"""
...
# Training loop
for epoch in range(epochs+1):
    for batch_idx, (data, targets) in enumerate(testloader_8):
